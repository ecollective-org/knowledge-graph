...
Status: **v0.3 draft specification (`docs/decisions/0003-…` landing on 0002); package 0.2.2
published on npmjs.com, public, under the `ecollective` organisation; 0.3.0 unreleased.** `schema.ts`, `validate.ts` and `build-artifact.ts`
exist with tests;

...
> **Status: v0.3 draft specification, landing change by change; package 0.2.2 published on
> npmjs.com, public (`npm install @ecollective/knowledge-graph@0.2.2`), 0.3.0 unreleased.** The
> specification is filed and citable.

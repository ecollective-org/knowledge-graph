...
> **Status: v0.3 draft specification; package 0.3.0 published on npmjs.com, public
> (`npm install @ecollective/knowledge-graph@0.3.0`).** The specification is filed and citable.
